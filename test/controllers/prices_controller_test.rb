...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { item_id: @price.item_id, price: @price.price, store_id: @price.store_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { itemId: @price.itemId, price: @price.price, storeId: @price.storeId } }
